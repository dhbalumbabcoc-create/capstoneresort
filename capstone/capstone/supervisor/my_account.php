...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['profile_photo']) && $_FILES['profile_photo']['error'] === UPLOAD_ERR_OK) {
        ...
        $filename = 'supervisor_' . $_SESSION['user_id'] . '_' . time() . '.' . $ext;
...
<head>
    ...
    <title>Account Settings - Supervisor</title>
    ...
    <div class="content" style="flex:1;min-width:0;">
        ...
        <div class="dash-body">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4">
                    <div class="settings-card" style="background:#fff;border-radius:16px;padding:28px;box-shadow:0 2px 12px rgba(0,0,0,.06);margin-bottom:24px;">
                        <h5 style="font-weight:800;color:#1a1a1a;margin-bottom:20px;padding-bottom:12px;border-bottom:1px solid #f0f0f0;"><i class="fas fa-id-card me-2" style="color:#1B7D3A;"></i>Profile Summary</h5>
                        <div class="text-center py-3">
                            ...
                            <span class="pill pill-green mt-2 d-inline-block">Supervisor</span>
                        </div>
                ...
                <div class="col-lg-8">
                    <div class="settings-card" style="background:#fff;border-radius:16px;padding:28px;box-shadow:0 2px 12px rgba(0,0,0,.06);margin-bottom:24px;">
                        <h5 style="font-weight:800;color:#1a1a1a;margin-bottom:20px;padding-bottom:12px;border-bottom:1px solid #f0f0f0;"><i class="fas fa-user-edit me-2" style="color:#1B7D3A;"></i>Edit Profile</h5>
                        <form method="POST" enctype="multipart/form-data" autocomplete="off">
                            <input type="file" id="photoInput" name="profile_photo" accept="image/*" style="display:none;">
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    <label class="form-label" style="font-size:.82rem;font-weight:700;color:#222;">First Name</label>
                                    <input type="text" class="form-control" name="first_name" value="<?= htmlspecialchars($user['first_name']??'') ?>" placeholder="First Name" style="border:1.5px solid #e0e0e0;border-radius:10px;font-size:.9rem;padding:10px 14px;">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label" style="font-size:.82rem;font-weight:700;color:#222;">Last Name</label>
                                    <input type="text" class="form-control" name="last_name" value="<?= htmlspecialchars($user['last_name']??'') ?>" placeholder="Last Name" style="border:1.5px solid #e0e0e0;border-radius:10px;font-size:.9rem;padding:10px 14px;">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label" style="font-size:.82rem;font-weight:700;color:#222;">Email Address</label>
                                <input type="email" class="form-control" name="email" value="<?= htmlspecialchars($user['email']??'') ?>" style="border:1.5px solid #e0e0e0;border-radius:10px;font-size:.9rem;padding:10px 14px;">
                            </div>
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    <label class="form-label" style="font-size:.82rem;font-weight:700;color:#222;">Phone</label>
                                    <input type="text" class="form-control" name="phone" value="<?= htmlspecialchars($user['phone']??'') ?>" placeholder="09XXXXXXXXX" style="border:1.5px solid #e0e0e0;border-radius:10px;font-size:.9rem;padding:10px 14px;">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label" style="font-size:.82rem;font-weight:700;color:#222;">Address</label>
                                    <input type="text" class="form-control" name="address" value="<?= htmlspecialchars($user['address']??'') ?>" placeholder="Address" style="border:1.5px solid #e0e0e0;border-radius:10px;font-size:.9rem;padding:10px 14px;">
                                </div>
                            </div>
                            <hr style="border-color:#f0f0f0;">
                            ...
                            <div class="mb-3">
                                <label class="form-label" style="font-size:.82rem;font-weight:700;color:#222;">New Password</label>
                                <input type="password" class="form-control" name="new_password" placeholder="Leave blank to keep current password" style="border:1.5px solid #e0e0e0;border-radius:10px;font-size:.9rem;padding:10px 14px;">
